...
<div class="container">
                        ...
                        <tbody>
                            <?php if ($result->num_rows > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $apptQuery = "SELECT id, appointment_date FROM appointments WHERE patient_id = $id";
                                        ...
                                        if ($apptResult->num_rows > 0) {
                                            while ($appt = $apptResult->fetch_assoc()) {
                                                ...
                                                $badgeClass = ($apptDate >= $today) ? 'success' : 'secondary';
    ...
    <div class="d-flex align-items-center justify-content-start gap-2 flex-nowrap">
        ...
        <a data-toggle="modal" data-target="#deletePatient<?= $id ?>" class="btn btn-sm btn-light" title="Delete">
            ...
            <div class="modal-body p-4">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>ABHA Number:</strong> <?= $row['abha_number'] ?></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>Sugar:</strong> <?= $row['sugar_level'] ?></p>
                        <p><strong>BP:</strong> <?= $row['bp'] ?></p>
                ...
                <!-- Address Full Width -->
                <div class="mt-3">
                    <p><strong>Address:</strong> <?= $row['address1'] ?> <?= $row['address2'] ?></p>
                </div>
        ...
        <form action="delete-patient.php" method="post">
            <div class="modal-content border-0 text-center p-3">
                ...
                <div class="modal-footer border-0 justify-content-center">
                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deletePatient<?= $row['id'] ?>">Delete</button>
